...
data/lunch_specials.json    592 lunch entries (27 original + 20 batch-2 + 54 batch-3 + 49 batch-4 + 101 batch-5 + 1 review-pass + 100 batch-6/7 on 2026-09-07 + 103 batch-8 on 2026-09-08 + 68 batch-9 on 2026-09-10 + 10 batch-10 on 2026-09-11 + 59 batch-11 on 2026-09-11), hours, days, prices, verification level
data/lunch_rejected.json    154 rejected/deferred rows covering 154 distinct businesses, each with a reason and a link
data/flags.json             56 irregularities found while verifying - all still listed
data/sources.json           120 source pages, what each one proved, and the fetch status
docs/VERIFICATION.md        how to re-check every row, and what could not be verified
docs/REVIEW_2026-09-11_pass11.md  current QA pass (the eleventh lunch pass), validation results
...
## Flagged irregularities (56)

Fourteen transit, forty-two lunch. Headlines:
